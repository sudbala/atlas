...
class AtlasBottomNavBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      child: Row(
        children: <Widget>[
          IconButton(icon: Icon(Icons.home, size: iconSize), onPressed: () {}),
          IconButton(icon: Icon(Icons.map, size: iconSize), onPressed: () {}),
          IconButton(
              icon: Icon(Icons.explore_rounded, size: iconSize),
              onPressed: () {}),
          IconButton(icon: Icon(Icons.person, size: iconSize), onPressed: () {})
        ],
      ),
    );
  }
